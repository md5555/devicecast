...
function MediaRendererClient(url, xml) {
...
MediaRendererClient.prototype.getTransportState = function(callback) {
...
function buildMetadata(metadata) {
  ...
  var duration = et.SubElement(item, 'dc:duration');
  duration.text = '99:99:00.000';
